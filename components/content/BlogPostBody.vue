<template>
  <main class="relative py-20">
    <div class="mx-auto px-4">
      ...
      <div class="pointer-events-none absolute left-0 top-0 hidden opacity-15 lg:block dark:opacity-10">
        <svg width="220" height="220" viewBox="0 0 220 220" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <path d="M60 160 Q 100 120 150 60" class="fill-none stroke-gray-800 dark:stroke-gray-200" stroke-width="1" stroke-dasharray="4 2" />
        </svg>
      </div>

      <!-- Large compass on right side -->
      <div class="pointer-events-none absolute top-1/4 hidden opacity-15 lg:right-16 lg:block xl:right-32 dark:opacity-10">
      ...
      <div class="pointer-events-none absolute bottom-10 hidden opacity-15 lg:left-32 lg:block xl:left-64 dark:opacity-10">
      ...
      <article class="prose dark:prose-invert relative mx-auto max-w-prose">
        <slot />
      </article>
    </div>
  </main>

<template>
  <main class="relative py-20">
    <div class="mx-auto px-4">
      ...
      <div class="pointer-events-none absolute bottom-10 left-32 hidden opacity-5 lg:block xl:left-64">
      ...
      <article class="prose dark:prose-invert prose-a:text-blue-600 hover:prose-a:text-blue-500 prose-li:list-none relative mx-auto max-w-prose">
        <slot />
      </article>
    </div>
  </main>
